  ...
  /* <div className="w-full mt-6 relative">
        <div className="w-full flex justify-between absolute">
          ...
          <Image
            src={SemicircleTwo}
            alt="SemicircleOne"
            className="fixed right-0 opacity-5"
          />
        </div>
        <div className="w-full h-[400px] absolute top-[50px] flex justify-between items-center sm:visible">
          <div className="w-[50%] h-full -space-y-10">
            <Image src={Innersix} alt="Innersix" />
            <Image src={Innerfive} alt="Innersix" />
            <Image src={Innerfour} alt="Innersix" />
          </div>
          <div className="w-[50%] h-full space-y-0">
            <Image
              src={Innerone}
              alt="Innersix"
              className="w-full ml-auto h-[120px]"
